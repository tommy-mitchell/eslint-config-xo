...
type MaybeFunction<T> = T | (() => T | false | undefined);

export type Sequence = Array<MaybeFunction<string> | MaybeFunction<Array<[string, delayRatio: number]>> | undefined>;

const parseSequence = (sequence: Sequence, delay: number): Array<string | number> =>
...
type TypewriterProps = Readonly<{
	className?: ClassName;
	/** Delay between items in milliseconds. @default 3000 */
	delay?: number;
	label: string;
	/** @default true */
	loop?: boolean;
